...
/**
 * Composant `FormRegister` qui fournit un formulaire d'inscription pour les nouveaux utilisateurs.
 * Les utilisateurs peuvent saisir leurs informations personnelles, y compris le nom, le prénom, le numéro de téléphone,
 * la date de naissance, l'adresse email, le mot de passe et sa confirmation.
 * Le formulaire intègre également un bouton pour afficher ou cacher le mot de passe.
 * Après l'inscription réussie, l'utilisateur est redirigé vers la page de connexion.
 *
 * Utilise une API pour créer un nouvel utilisateur et des toasts pour notifier l'utilisateur du résultat de l'inscription.
 *
 * @returns {JSX.Element} Un formulaire d'inscription avec des champs pour les informations personnelles et les options de gestion de mot de passe.
 */
